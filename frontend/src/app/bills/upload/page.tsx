...
export default function UploadBillPage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setResult(response as UploadResult);
      setFile(null);
    } catch (err: any) {
            ...
            <div className="mt-6 space-y-4">
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button
                    onClick={() => router.push(`/bills/${result.bill_id}`)}
                  ...
                  <div className="bg-white p-4 rounded-lg">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <span className="font-medium">
                          ₹{result.extracted_data.total_amount?.toLocaleString('en-IN') || 'N/A'}
                        </span>
                      </div>
                      <div>
                        <span className="text-gray-600">Date:</span>{' '}
                        <span className="font-medium">
                          {result.extracted_data.bill_date || 'N/A'}
                        </span>
                      </div>
                      <div>
                        <span className="text-gray-600">Category:</span>{' '}
                        <span className="font-medium">
                          {result.extracted_data.category || 'N/A'}
                        </span>
                      </div>
                    </div>
                  </div>
